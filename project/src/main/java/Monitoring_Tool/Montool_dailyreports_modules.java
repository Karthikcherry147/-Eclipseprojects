...
public class Montool_dailyreports_modules {
	...
	public void einvoice_mode_wise(WebDriver driver,XSSFCell cell, XSSFSheet worksheet , XSSFWorkbook  wb, FileInputStream fsIP, JavascriptExecutor js) throws InterruptedException
	{
		try
		{
			...
			System.out.println("eINVOICE Mode Start");
		...
		System.out.println("eINVOICE Mode end" );
	...
	public void einvoice_Zone_Wise(WebDriver driver,XSSFCell cell, XSSFSheet worksheet , XSSFWorkbook  wb, FileInputStream fsIP, JavascriptExecutor js) throws InterruptedException
	{
		...
		try
		{
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//input[@id='ctl00_ContentPlaceHolder1_btn_refresh']")).click();
			System.out.println("eINVOICE Zone Wise working fine");
			String strText027 = driver.findElement(By.xpath("//*[@id=\"ctl00_ContentPlaceHolder1_grd_zone\"]/tbody/tr[3]/td[11]")).getText();
			String strText028 = driver.findElement(By.xpath("//*[@id=\"ctl00_ContentPlaceHolder1_grd_zone\"]/tbody/tr[4]/td[11]")).getText();
...
//
//	}
//	public void RECONCOLIATION(WebDriver driver,XSSFCell cell, XSSFSheet worksheet , XSSFWorkbook  wb, FileInputStream fsIP, JavascriptExecutor js ) throws InterruptedException
//	{
//		try
//		{
...
//		       int c2 = Integer.parseInt(s3);
//		       int d2 = Integer.parseInt(s4);
//		       int e31 = Integer.parseInt(s5);
//		       cell = worksheet.getRow(18).getCell(1);
//		       if (a25==b25 && b25==c2&& c2==d2 && d2==e31)
//		       {
//		    	   cell.setCellValue("OK");
