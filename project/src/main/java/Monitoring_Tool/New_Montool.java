...
//	robot.keyPress(KeyEvent.VK_F11);
	...
	New_Montool_modules mt = new New_Montool_modules();
...
//	mt.einvoice_mode_wise(driver, null, worksheet, wb, fsIP, js); // wORKING
////	mt.einvoice_Zone_Wise(driver, null, worksheet, wb, fsIP, js);
//	mt.ewaybill_mode_wise(driver, null, worksheet, wb, fsIP, js);    // wORKING
//	//mt.ewaybill_Zone_wise(driver, null, worksheet, wb, fsIP, js);
//	mt.einvoice_log_error(driver, null, worksheet, wb, fsIP, js);   //Working
//	mt.ewaybil_log_error(driver, null, worksheet, wb, fsIP, js);   //Working
//	mt.GSTIN_details_Fr_CP(driver, null, worksheet, wb, fsIP, js); //Working
//	mt.Block_status_Fr_CP(driver, null, worksheet, wb, fsIP, js); //Working
//	mt.Vahan_details(driver, null, worksheet, wb, fsIP, js);//Working
//	mt.PAN_details(driver, null, worksheet, wb, fsIP, js);//Working
//	mt.Fastag_date_Wise(driver, null, worksheet, wb, fsIP, js);//Working
//    mt.Fastag_Time_match(driver, null, worksheet, wb, fsIP, js); //Working
//    mt.einvoice_dex(driver, null, worksheet, wb, fsIP, js);//Working
//    mt.ewaybill_dex(driver, null, worksheet, wb, fsIP, js);//Working
    mt.Fastag_Dex_Summaryreport(driver, null, worksheet, wb, fsIP, js);
//    mt.eINVOCIE_DATA_Consistency(driver, null, worksheet, wb, fsIP, js);//Working
//    mt.IRN_DATA_Consistency(driver, null, worksheet, wb, fsIP, js);//Working
